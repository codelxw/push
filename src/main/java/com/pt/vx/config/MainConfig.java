...
public class MainConfig {
    ...
    static {
        ...
        weatherOtherInfos.add(new WeatherOtherInfo(0,"<10","今天天气有点冷，注意保暖哦~"));
        weatherOtherInfos.add(new WeatherOtherInfo(0,">30","天气热起来了哦，不要穿太多咯~"));
        weatherOtherInfos.add(new WeatherOtherInfo(1,"今天可能要下雨呢","出门记得带伞哦！"));
