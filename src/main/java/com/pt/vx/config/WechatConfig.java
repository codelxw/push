...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wx411f8c380b7da616";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "6c248d790f2c028b6957be4237bdee67";
    ...
    static {
        userList.add(getUser(
                "ocXBV6QkFvZquZoCrZyibOFGQ-Dg", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "OO-vcavkEAf0-87-_TX17iVWiC5eUfEpZwyl8zRa8v4", //要给这个人发送的模板ID
                "圆子", //咋称呼这个人
                "江西省南昌市新建区", //这个人的详细地址
                "南昌", //这个人在的城市
                new BirthDay(1999,8,23,false,false,"宝宝生日快乐！！"),
                new BirthDay(2024,4,20,false,true,"")
        ));
